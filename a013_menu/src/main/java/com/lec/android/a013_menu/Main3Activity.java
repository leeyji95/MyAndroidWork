...
public class Main3Activity extends AppCompatActivity {
    ...
    ActionBar abar; // androidx 로 import
...
//        abar.show(); // 액션바 보이기
        ...
        btnActionIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                abar.setDisplayOptions(ActionBar.DISPLAY_SHOW_HOME | ActionBar.DISPLAY_USE_LOGO); // 로고 사용하겠다고 명시하는 것
                // 홈 아이콘 사용하려고 할 떄 ,show home 꼭 해줘야 보인다.
            }
        });
            /*
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        View v = menu.findItem(R.id.menu_search).getActionView(); // 그것(MenuItem 객체)의 겟액션뷰 얻어온다.
