...
public class Main4Activity_radioButton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg = findViewById(R.id.rg);  // id 값도 rafactoring 됨.
        ...
        btnResult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 먼저 선택된 라디오버튼의 id 값 가져오기
                int id = rg.getCheckedRadioButtonId(); // 라디오 그룹에 있는 getch~ 가져오기

                // 그 다음 위 id 값을 통해 RadioButton 객체 가져오기
